...
$gkey="Ваш_ключ"; // Ключ от антигейта
$capcha_server = "antigate.com"; // Сервер антигейта

// Количество действий бота(отладочный алгоритм)
$step_main = 10; // Общее количество шагов по основной программе

// Клан
$UseClansBottle = true; // Используем бутылочку при битве для клана

// Башни
$UseTowersBottle = false; // Использовать бутылки с лекарством во время боя в Башнях?
$step_tower = 1001; // Количество шагов в битве за Башни

// Арена
$UseArenaBottle = true; // Использовать бутылки с лекарством во время боя на Арене?
$colArenaCikl = 10; // Количество шагов в битве на Арене

// Выживание
$UseSurvivalBottle = true; // Использовать бутылки с лекарством во время боя в Выживании?
$colSurvivalCikl = 10; // Количество шагов в битве на Выживание

// Пещеры и драконы
$UseDungeonsBottle = true; // Использовать бутылки с лекарством во время боя в Башнях?

// Включить\Отключить проверку "усталости" для игнорирования битвы в "Башнях"
$pUstal = 1;

// Логин пользователя
$game_login = ""; // Пробел в логине заменить на +
// Пароль пользователя
$game_password = "";
